#!/usr/bin/env bash
# jev orchestration wave batch runner.
...
#     { "model": "glm-5.3-flash:cloud", "brief": ".jev/briefs/x.md", "role": "implementer" }
...
#   .jev/runs/. Exit code: 0 if every item succeeded, 1 if any failed,
#   3 on bad arguments.
set -uo pipefail
